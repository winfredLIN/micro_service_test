...
func New_Cart(userId uint, commodityId uint, commodityName string, commodityPrice float32) (result shoppingCart, err error) {
...
func Retrieve_Cart(cartId uint) (result shoppingCart, err error) {
...
func Delete_Cart(cartId uint) (err error) {
	var cart shoppingCart
	db, err := gorm.Open("sqlite3", "lib/lib_files/Shopping_Cart.db")
	if err != nil {
